            ...
            <div class="card-body">
                ...
                <div class="row">
                    <form class="form-group">
                        <div class="col-md-4">
                            <!-- Search form -->
                            <input class="form-control" type="text" placeholder="Enter Property Id" aria-label="Search">
                        </div>
                        ...
                        <div class="col-mid-2">
                            ...
                            <form class="form-group">
                                <!-- Search Id -->
                                <button class="btn btn-primary" type="text" aria-label="Search"><i
                        ...
                        <div class="col">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#AddPropertyList"> <i class="fas fa-plus"></i> Add Property Listing
                            </button>
                    </form>
                </div>
...
<div class="modal fade bd-example-modal" id="AddPropertyList" tabindex="-1" role="dialog"
                            ...
                            <div class="col-md-12">
                                <form id="propertyForm" action="includes/propertyupload.inc.php" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <textarea class="form-control" name='listing-desc'></textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
    ...
    <!-- Save Changes Modal -->
    <div class="modal fade" id="SaveChanges" tabindex="-1" role="dialog" aria-labelledby="SaveChanges"
        aria-hidden="true">
    ...
    <!-- Edit Property Modal -->
    <!-- <div class="modal fade bd-example-modal-lg" id="EditProperty" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card container-fluid">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="listing-title" class="col-4 col-form-label">Listing Title</label>
                            <div class="col-8">
                                <input id="listing-title" name="listing-title" placeholder="Enter Listing Title"
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-4 col-form-label">Property Type</label>
                            <div class="col-8">
                        ...
                        <div class="form-group row">
                            <label for="onlyNumbers1" class="col-4 col-form-label">Lot Area (per sqm)</label>
                            <div class="col-8">
                                <input type="text" class="form-control" placeholder="0" id="onlyNumbers1"
                                    name="onlyNumbers1" onkeypress="return isNumber(event)" onpaste="return false;"
                                    aria-label="" aria-describedby="button-addon3">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="onlyNumbers2" class="col-4 col-form-label">Floor Area (per sqm)*</label>
                            <div class="col-8">
                                <input type="text" class="form-control" placeholder="0" id="onlyNumbers2"
                                    name="onlyNumbers2" onkeypress="return isNumber(event)" onpaste="return false;"
                                    aria-label="" aria-describedby="button-addon3">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="bedroom" class="col-4 col-form-label">No. of Bedrooms</label>
                            <div class="col-8">
                                <input type="number" min="1" max="10" class="form-control" placeholder="0" id="bedroom"
                                    name="minbr" onkeypress="return isNumber(event)" onpaste="return false;"
                                    aria-label="" aria-describedby="button-addon3">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="bathroom" class="col-4 col-form-label">No. of Bathrooms</label>
                            <div class="col-8">
                                <input type="number" min="1" max="10" class="form-control" placeholder="0" id="bathroom"
                                    name="bathroom" onkeypress="return isNumber(event)" onpaste="return false;"
                                    aria-label="" aria-describedby="button-addon3">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input id="fileReplacePhoto" type="file" style="display:none;" />
                                <input type="button" class="btn btn-secondary w-85" value="Replace Image"
                                    onclick="document.getElementById('fileReplacePhoto').click();" />
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="location.href='index.html';">Save</button>
                </div>
                <br><br>
            </div>
        </div>
