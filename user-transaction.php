            ...
            <div class="modal-body">
                <form id='addTransactionForm' method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select class="form-control transform" id="allPropertyHolder"
                                onchange="propertyNameBehavior(this.value)" name="agentProperties" style="width: 100%">
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <form id='editTransactionForm' method="post">
                    ...
                    <div class="form-group row hidden" id="eDateOf">
                        <label for="allPropertyHolder" class="col-4 col-form-label">Date of
                            Reservation</label>
                        <div class="col-8">
                            <input type="date" class="form-control" placeholder="Date of sale*" name="eSaleDate" />
                        </div>
                    </div>
