...
<body id="page-top">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id='registraitonForm' action="includes/signup.inc.php" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <button type="submit" name="registration-submit" class="btn btn-primary btn-blue" data-toggle="modal" data-target="#Register" data-dismiss="modal" /> <i class="fab fa-facebook-f"></i>&nbsp;&nbsp;&nbsp;Sign Up with Facebook </button>
                        </div>
                    </form>
                    <br>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 login-form-1">
                            ...
                            <form id='loginForm' action="includes/login.inc.php" method="post">
                                ...
                                <div class="form-group">
                                    <button type="Submit" class="btn btn-primary btn-blue" data-toggle="modal" data-target="#Register" data-dismiss="modal"> <i class="fab fa-facebook-f"></i>&nbsp;&nbsp;&nbsp;Sign in with
    ...
    <script>
           ...
           localStorage.setItem(`userlogged`,<?php echo $_SESSION['userid']?>)
