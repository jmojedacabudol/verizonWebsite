                    ...
                    <form id='navForm' action="properties.php" method="get">
                        ...
                        <li class="nav-item mx-0 mx-lg-1 dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                                ...
                                <div class="dropdown-divider"></div>
                                <button class="dropdown-item" type='submit' name="propertyType" value="Farm Lots"
                                    id='propFarmLots'>Farm
                                    Lots</button>
                                <div class="dropdown-divider"></div>
                    ...
                    <form id='registraitonForm' action="includes/signup.inc.php" method="post"
                        ...
                        <div class="form-group">
                            <button type="submit" name="registration-submit" class="btn btn-primary btn-blue"
                                data-toggle="modal" data-target="#Register" data-dismiss="modal" /> <i
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 login-form-1">
                            ...
                            <form id='loginForm' action="includes/login.inc.php" method="post">
                                ...
                                <div class="form-group">
                                    <a data-toggle="modal" data-target="#Register" data-dismiss="modal"
